...
CREATE TABLE `attendances` (
  ...
  CONSTRAINT `attendances_employee_code_foreign` FOREIGN KEY (`employee_code`) REFERENCES `workfolio_main`.`employees` (`code`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `company_loans` (
  ...
  CONSTRAINT `company_loans_employee_code_foreign` FOREIGN KEY (`employee_code`) REFERENCES `workfolio_main`.`employees` (`code`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ess_accounts` (
  ...
  CONSTRAINT `ess_accounts_employee_code_foreign` FOREIGN KEY (`employee_code`) REFERENCES `workfolio_main`.`employees` (`code`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `loans` (
  ...
  CONSTRAINT `loans_employee_code_foreign` FOREIGN KEY (`employee_code`) REFERENCES `workfolio_main`.`employees` (`code`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `overtimes` (
  ...
  CONSTRAINT `overtimes_employee_code_foreign` FOREIGN KEY (`employee_code`) REFERENCES `workfolio_main`.`employees` (`code`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payrolls` (
  ...
  CONSTRAINT `payrolls_employee_code_foreign` FOREIGN KEY (`employee_code`) REFERENCES `workfolio_main`.`employees` (`code`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
