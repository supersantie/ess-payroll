            ...
            <div class="card mb-0">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-4">
                        <input type="text" class="form-control" name="" maxlength="1" size="1" pattern="[0-9]" inputmode="numeric" autocomplete="off" autofocus required />
                        <input type="text" class="form-control" name="" maxlength="1" size="1" pattern="[0-9]" inputmode="numeric" autocomplete="off" required />
                        <input type="text" class="form-control" name="" maxlength="1" size="1" pattern="[0-9]" inputmode="numeric" autocomplete="off" required />
                        <input type="text" class="form-control" name="" maxlength="1" size="1" pattern="[0-9]" inputmode="numeric" autocomplete="off" required />
                        <input type="text" class="form-control" name="" maxlength="1" size="1" pattern="[0-9]" inputmode="numeric" autocomplete="off" required />
                        <input type="text" class="form-control" name="" maxlength="1" size="1" pattern="[0-9]" inputmode="numeric" autocomplete="off" required />
