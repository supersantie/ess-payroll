...
@slot('subtitle') Leave of Absence @endslot
@endcomponent
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Leave of Absence List</h5>
        </div>
        ...
        <table class="table datatable-responsive">
            ...
            <tbody>
                @foreach ($employees as $item) 
                    @foreach ($item->leaves as $subItem)
                    <tr>
                        ...
                        <td>{{ $subItem->leave_type }}</td>
                        <td>{{ $subItem->proof_of_leaving }}</td>
                        <td>{{ $subItem->no_of_days }}</td>
                        <td>{{ $subItem->date_filed }}</td>
                        <td>{{ $subItem->effectivity_date }}</td>
