...
<script src="{{URL::asset('assets/js/vendor/tables/datatables/row_reorder.min.js')}}"></script>
<script src="{{URL::asset('assets/js/vendor/tables/datatables/extensions/responsive.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/pages/datatables_extension_row_reorder.js')}}"></script>
@endsection
