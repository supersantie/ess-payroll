...
<script src="{{URL::asset('assets/js/vendor/editors/ckeditor/ckeditor_balloon.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/pages/editor_ckeditor_balloon.js')}}"></script>
@endsection
