...
<script src="{{URL::asset('assets/js/vendor/tables/datatables/extensions/key_table.min.js')}}"></script>
@endsection
@section('scripts')
<script src="{{URL::asset('assets/demo/pages/datatables_extension_key_table.js')}}"></script>
@endsection
